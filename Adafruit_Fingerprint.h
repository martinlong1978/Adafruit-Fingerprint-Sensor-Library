...
#define FINGERPRINT_LED_GREEN 0x04         //!< Red LED
#define FINGERPRINT_LED_YELLOW 0x05        //!< Blue LED
#define FINGERPRINT_LED_CYAN 0x06      //!< Purple LEDpassword
#define FINGERPRINT_LED_WHITE 0x07         //!< Red LED
